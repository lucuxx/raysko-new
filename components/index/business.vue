...
export default {
  ...
  data() {
    return {
      ...
      productList: [
        {id: 1, icon: require('~/static/img/business/business01.jpg'), title: '互联网+政务', desc: '深圳睿思科以阿里、数梦工场为基础，将互联网的能力与政务进行创新融合，在流程优化的基础上，引入以资源集约共享、弹性伸缩、极致体验、敏捷支撑为特征的互联网技术，从而实现政务便民服务、政务管理与辅助决策以及产业支持等精细化的政务体系。'},
