  ...
  <section class="technology">
    <div class="header-content spin-content" >
      <div style="height: 100%">
        <div class="flex">
          <div class="content">
            <h1 class="wow slideInLeft">技术与支持</h1>
            <p class="wow slideInRight">顶尖技术,24H支持</p>
          </div>
        </div>
      </div>
    </div>
            ...
            <b-row align-h="center">
              <b-col md="8">
                <b-form @submit="onSubmit" class="mt-4 mb-5">
                  ...
                  <b-button type="submit" block variant="primary">提 交</b-button>
                </b-form>
              </b-col>
            </b-row>
          </template>
  ...
  data() {
    return {
      ...
      list: [
        {
          title: '服务理念',
          desc:   `<p style="text-indent: 2em">大数据被认为是继信息化和互联网后整个信息革命的又一次高峰。云计算和大数据共同引领以数据为材料，计算为能源的又一次生产力的大解放。深圳睿思科信息技术有限公司是大数据价值创新与行动的先驱者，赋予引领人们进入大数据时代为使命，以成为最值得信赖的大数据服务公司为愿景，诚信、尊重、团队与专业，扮演了贯彻使命与实现愿景的重要角色，为政府、企业等组织提供大数据产品及服务。</p>
          <p style="text-indent: 2em">深圳睿思科信息技术有限公司始终贯彻自主创新风格，无论是产品技术抑或经营管理，都包含了别出心裁的创意及与时俱进的思想。在未来，睿思科还将继续以客户服务为中心，提供体系化、标准化、细节化、高价值化的服务，在企业信息化IT服务领域不断创新，并获得永不枯竭的长远发展动力。面对日益复杂的商业环境，企业需要借助更专业、更符合企业个性需求的服务来提升信息化系统的应用能力和水平，深圳睿思科信息技术有限公司主要从事大数据产品的研发，一直以强大的先进技术力量为后盾，以创新思维而立身，又因不断革新的数据技术而持续进步，并带来了累累硕果。</p>
          <p style="text-indent: 2em">企业需要建立基于海量数据的深入分析能力。在大数据时代，数据分析能力的强弱，类似于工业时代制造工艺的先进与否。我们的目标客户有较高的数据分析挖掘需求，帮用户解决数据的处理问题，根据客户的特点进行推荐产品，进行个性化的页面展示。我们以标准化的服务用语，热诚的服务态度，清新的服务形象面对广大客户，广泛采纳用户意见，认真处理用户投诉，以严格的监管体制保护用户的各项权益。当您作为尊敬的用户选择深圳睿思科信息技术有限公司产品的同时，您也将享受到国内同类行业中最专业、最富有责任心、最完善周到的技术服务。</p>`
        },
        {
          title: '服务体系',
          desc: `<p style="text-indent: 2em">我公司提供优秀的技术支持和售后服务,确保本公司所提供的产品在运行期间能够稳定、安全、高效的运行，从而保证用户业务的正常运行。</p>
            ...
            售后服务<br/>
            <p style="text-indent: 2em">深圳睿思科信息技术有限公司致力于为用户提供最专业及最完善的售后服务。客户如果在使用产品过程中遇到了困难，可以通过在线服务平台进行咨询深圳睿思科信息技术有限公司，一线的服务团队会与客户进行对接，最大程度让客户满意。</p>
            服务承诺<br/>
            实时技术支持<br/>
            ...
            响应服务模式<br/>
            <p style="text-indent: 2em">深圳睿思科信息技术有限公司可以根据具体项目的实际情况，为用户提供优质的7×24热线响应服务模式。7×24热线响应服务模式，用户可以通过不同方式向我司技术人员提出技术响应需求。如：通过电话、传真、信函、E-mail、来访。</p>
...
.header-content {
  background: url("~/static/img/banner/inside-banner5.jpeg") center center
    no-repeat;
