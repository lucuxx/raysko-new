  ...
  <section>
    ...
    <div class="header-content spin-content">
      <div style="height: 100%">
        <div class="flex">
          <div class="content">
            <h1 class="wow slideInLeft">解决方案</h1>
            <p class="wow slideInRight">提供整体行业解决方案，为您解决复杂问题</p>
          </div>
        </div>
      </div>
    </div>
            ...
            <b-row class="content" no-gutters>
              ...
              >
                <b-card-img
                  ...
                  height="300"
                  fluid
                  class="rounded-0 picture"
                  :class="{ special: index == 1 }"
                ></b-card-img>
              </b-col>
              <b-col
                :data-wow-delay="0.2 * index + 's'"
              ...
              >
                <b-card-body
                  class="h-100 d-flex justify-content-center align-items-center flex-column text-center"
                >
      ...
      productList: [
        {
          ...
          title: "互联网+政务",
          desc: "深圳睿思科以阿里、数梦工场为基础，将互联网的能力与政务进行创新融合，在流程优化的基础上，引入以资源集约共享、弹性伸缩、极致体验、敏捷支撑为特征的互联网技术，从而实现政务便民服务、政务管理与辅助决策以及产业支持等精细化的政务体系。",
        },
        {
          id: 2,
