  ...
  <section class="section-wrap">
    ...
    <div class="product-nav-wrap">
      <div class="container mx-auto product-nav">
        <div class="product-nav-left">R366A</div>
      ...
      <section id="overview">
        <div id="insmeter-img">
          <b-img
            class="wow fadeInUp"
            fluid
            :src="require('~/static/img/R366A/R366A_detail_01.png')"
          ></b-img>
          <b-img
            class="wow fadeInUp"
            fluid
            :src="require('~/static/img/R366A/R366A_detail_02.png')"
          ></b-img>
          <b-img
            class="wow fadeInUp"
            fluid
            :src="require('~/static/img/R366A/R366A_detail_03.png')"
          ></b-img>
          <b-img
            class="wow fadeInUp"
            fluid
            :src="require('~/static/img/R366A/R366A_detail_04.png')"
          ></b-img>
          <b-img
            class="wow fadeInUp"
            fluid
            :src="require('~/static/img/R366A/R366A_detail_05.png')"
          ></b-img>
          <b-img
            class="wow fadeInUp"
            fluid
            :src="require('~/static/img/R366A/R366A_detail_06.png')"
          ></b-img>
          <b-img
            class="wow fadeInUp"
            fluid
            :src="require('~/static/img/R366A/R366A_detail_07.png')"
          ></b-img>
          <b-img
            class="wow fadeInUp"
            fluid
            :src="require('~/static/img/R366A/R366A_detail_08.png')"
          ></b-img>
