  ...
  <section class="section-wrap">
    ...
    <div class="product-nav-wrap">
      <div class="container mx-auto product-nav">
        <div class="product-nav-left">R7</div>
      ...
      <section id="overview">
        <div id="insmeter-img">
          <b-img
            class="wow fadeInUp"
            fluid
            :src="require('~/static/img/R7/R7_detail_01.png')"
          ></b-img>
          <b-img
            class="wow fadeInUp"
            fluid
            :src="require('~/static/img/R7/R7_detail_02.png')"
          ></b-img>
          <b-img
            class="wow fadeInUp"
            fluid
            :src="require('~/static/img/R7/R7_detail_03.png')"
          ></b-img>
          <b-img
            class="wow fadeInUp"
            fluid
            :src="require('~/static/img/R7/R7_detail_04.png')"
          ></b-img>
          <b-img
            class="wow fadeInUp"
            fluid
            :src="require('~/static/img/R7/R7_detail_05.png')"
          ></b-img>
          <b-img
            class="wow fadeInUp"
            fluid
            :src="require('~/static/img/R7/R7_detail_06.png')"
          ></b-img>
        </div>
      </section>
