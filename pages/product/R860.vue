  ...
  <section class="section-wrap">
    ...
    <div class="product-nav-wrap">
      <div class="container mx-auto product-nav">
        <div class="product-nav-left">R860</div>
    ...
    <div style="border-bottom: 1px solid gray">
      <section id="overview">
        <div id="insmeter-img">
          <b-img
            fluid
            :src="require('~/static/img/R860/860-xiangqing_01.png')"
          ></b-img>
          <b-img
            fluid
            :src="require('~/static/img/R860/860-xiangqing_02.png')"
          ></b-img>
          <b-img
            fluid
            :src="require('~/static/img/R860/860-xiangqing_03.png')"
          ></b-img>
          <b-img
            fluid
            :src="require('~/static/img/R860/860-xiangqing_04.png')"
          ></b-img>
          <b-img
            fluid
            :src="require('~/static/img/R860/860-xiangqing_05.png')"
          ></b-img>
          <b-img
            fluid
            :src="require('~/static/img/R860/860-xiangqing_06.png')"
          ></b-img>
          <b-img
            fluid
            :src="require('~/static/img/R860/860-xiangqing_07.png')"
          ></b-img>
          <b-img
            fluid
            :src="require('~/static/img/R860/860-xiangqing_08.png')"
          ></b-img>
          <b-img
            fluid
            :src="require('~/static/img/R860/860-xiangqing_09.png')"
          ></b-img>
        </div>
      </section>
          ...
          <table>
            <tbody>
              ...
              <tr>
                <td>内存（ROM+RAM）</td>
                <td>
                  5G：64GB+4GB（标配），128GB+6GB（选配）<br />4G：64GB+4GB
                </td>
              </tr>
              ...
              <tr>
                <td>扫描距离</td>
                <td>
                  Code128（3.3mil）：10.0cm ~15.0cm
                  <br />Code128（15mil）：5.5cm ~ 71.0cm <br />QR
                  Code（7.5mil）：11.0cm ~ 17.5cm <br />QR
              ...
              <tr>
                <td>提示2</td>
                <td>
                  本产品包含4G/5G两个版本，详细产品参数可下载产品彩页了解。
                </td>
              </tr>
            </tbody>
          </table>
